...
4. The request was not successfully authenticated, and the highest priority authentication class does use WWW-Authenticate headers. — An HTTP 401 5. Unauthorized response, with an appropriate WWW-Authenticate header will be returned.
